...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.frame = CGRectMake(0, 0, LVScreen_Size.width, 216);
...
-(void)confirmBtn:(UIButton*)btn{
    if ([self.delegate respondsToSelector:@selector(keyboard:didClickConfirmButton:)]) {
        [self.delegate keyboard:self didClickConfirmButton:btn];
    }
}
